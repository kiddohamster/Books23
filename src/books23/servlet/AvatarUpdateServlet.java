...
@WebServlet(urlPatterns = { "/avatarUpdate"})
public class AvatarUpdateServlet extends HttpServlet {
  private static final long serialVersionUID = 1L;
 
  public AvatarUpdateServlet() {
      super();
  }
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      // đặt trong WEB-INF)
      RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/WEB-INF/views/avatarUpdateView.jsp");
